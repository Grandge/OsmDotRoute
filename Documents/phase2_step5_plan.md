...
- [x] 本計画書 v0.1 のユーザーレビュー（2026-05-25、合意済）
- [x] サブステップ 5.1 完了（2026-05-25、commit `40fe294`、OdrgReader + 22 テスト + 全 500 件 pass）
- [x] サブステップ 5.2 完了（2026-05-25、commit `50cfcca`、INT-1〜INT-10 × 合成+津島 = 20 テスト + 全 520 件 pass）
- [x] サブステップ 5.3 完了（2026-05-25、commit `9c3965e`、PAR-1〜PAR-4 + 診断 + ヘルパ妥当性 = 6 テスト + 全 526 件 pass、頂点数比 0.892 / 辺数比 0.937 / PAR-4 完全一致）
- [x] サブステップ 5.4 完了（2026-05-25、commit `4a5a90a`、MapVerifier Server + Web 拡張、`samples/Data/tsushima.odrg` 同梱、smoke test pass）
- [x] サブステップ 5.5 完了（2026-05-25、設計書 §6 §7 §8 初版執筆、実装計画書 §6 §10 §11 完了反映、メモリ更新）
- [ ] **v0.2.0 タグ判断**（ユーザー承認待ち、Phase 2 終了確定）
...
| 0.2 | 2026-05-25 | **ステップ 5 全完了反映**。§10 次のアクションを 5.1〜5.5 完了マーク済に更新（各 commit SHA 記録: 5.1=`40fe294`, 5.2=`50cfcca`, 5.3=`9c3965e`, 5.4=`4a5a90a`, 5.5=本コミット）。オープン課題 Q1〜Q4 はサブ実装時に全解決（Q1: ヘルパ実装、Q2: ±30% で OK、Q3: 赤+破線で視認性 OK、Q4: 単独表示不要）。v0.2.0 タグ判断ペンディング | Claude (Opus 4.7) |
