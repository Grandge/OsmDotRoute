...
**ステータス**: サブステップ 3.1〜3.2 完了 / 3.3〜3.9 未着手
...
### 5.3 サブステップ 3.3 以降の予定

3.3 では Way の参照ノード出現回数を 1 パス目で計測し、回数 ≥ 2 のノードを頂点（交差点）、それ以外をシェイプ点とする頂点正規化を実装する。Way フィルタ (3.2) と組み合わせ、PBF 走査回数を計画書 §5.3.3 の 2〜3 パスに収める。
